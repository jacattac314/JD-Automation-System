...
class Config:
    ...
    def __init__(self):
        ...
        # LinkedIn (optional)
        self.enable_linkedin = os.getenv("ENABLE_LINKEDIN_INTEGRATION", "false").lower() == "true"
        self.linkedin_client_id = os.getenv("LINKEDIN_CLIENT_ID", "")
        self.linkedin_client_secret = self._get_secret("LINKEDIN_CLIENT_SECRET") if self.enable_linkedin else ""
        self.linkedin_access_token = self._get_secret("LINKEDIN_ACCESS_TOKEN") if self.enable_linkedin else ""
    ...
    def validate(self) -> tuple[bool, list[str]]:
        ...
        if self.enable_linkedin:
            if not self.linkedin_access_token:
                errors.append("LINKEDIN_ACCESS_TOKEN is required when LinkedIn integration is enabled")
